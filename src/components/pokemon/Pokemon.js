...
export default class Pokemon extends Component {
  ...
  /*  const pokeName = this.props.match.params.name;
    ...
    const height =
      Math.round((pokemonRes.data.height) * 10) / 100;

    const weight =
      Math.round((pokemonRes.data.weight) * 10) / 100;
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="row">
                  ...
                  <div className="col-6">
                    <h6 className="float-right">Genre:</h6>
                  </div>
                  <div className="col-6">
                    <div class="progress">
                      <div
              ...
              <div className="col-md-6">
                <div className="row">
                  <div className="col-6">
                    <h6 className="float-right">Espèce:</h6>
                  </div>
                  <div className="col-6">
                    <h6 className="float-left">{this.state.eggGroups} </h6>
                  </div>
                  <div className="col-6">
                    <h6 className="float-right">Éclosion:</h6>
                  </div>
                  <div className="col-6">
                    <h6 className="float-left">{this.state.hatchSteps}</h6>
                  </div>
                  <div className="col-6">
                    <h6 className="float-right">Pouvoirs:</h6>
                  </div>
                  <div className="col-6">
